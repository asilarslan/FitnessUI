...
struct YearView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 25) {
            Text("This Year Workout in Hours")
                .font(.system(size: 22))
                .fontWeight(.bold)
                        ...
                        VStack(alignment: .center) {
                            VStack {
                                ...
                                RoundedShape()
                                    ...
                                    // max height = 200
                                    .frame(height: getHeight(value: getTotalWorkoutMin(val:year) / 5))
                            }
                            .frame(height: 220)
                            .onTapGesture {
    ...
    func getTotalWorkoutMin(val: Date) -> CGFloat {
        ...
        for day in mainViewModel.workoutData {
            if val.month == day.date.month  && val.year == day.year {
